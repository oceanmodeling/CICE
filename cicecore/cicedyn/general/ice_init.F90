...
! author Elizabeth C. Hunke, LANL
      ...
      real (kind=dbl_kind) :: ustar_min, albicev, albicei, albsnowv, albsnowi, &
        ...
        windmin, drhosdwind, snwlvlfac, tscale_pnd_drain, depressT
      ...
      namelist /forcing_nml/ &
        ...
        vapor_flux_correction, sea_ice_bry_dir
...
!         file=__FILE__, line=__LINE__)
      ...
      sea_ice_bry_dir = ' '       ! directory for sea-ice boundary condition
...
!         write(nu_diag,1011) ' lcdf64           = ', lcdf64   ! deprecated
      ...
      call icepack_init_parameters(ustar_min_in=ustar_min, albicev_in=albicev, albicei_in=albicei, &
         ...
         tscale_pnd_drain_in=tscale_pnd_drain, sea_ice_time_bry_in=sea_ice_time_bry,depressT_in=depressT)
